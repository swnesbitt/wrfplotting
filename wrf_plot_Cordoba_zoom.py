...
outpath='/data/meso/a/snesbitt/wrf3911_2/fcsts/'+modname+'/'+run+'/images-cor'
...
# Get the latitude and longitude points
    ...
    for key in landmark_dict.keys():
        ...
        plt.text(kx,ky,key,fontsize=14,
...
#----
    ...
    plt.savefig(outpath+'/'+params['modfld']+'/model.'+params['modname']+'.'+params['times'][0].strftime('%Y%m%d%H%M')+'.'+'{:03d}'.format(timediff_secs)+'_'+params['modfld']+'.png',dpi=150,bbox_inches='tight')
